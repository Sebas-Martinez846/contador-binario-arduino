...
### 1. Reto 1: Aumento de Velocidad (`Tiempo_reducido.ino`)
...
### 2. Reto 2: Conteo Descendente (`contar_atras.ino`)
...
### 3. Reto 3: Modo Manual con Botón (`circuito_con_boton.ino`)
...
### 4. Reto 4: Números Pares (`numeros_pares.ino`)
...
### 5. Reto 5: Quinto LED como Indicador de Tope (`quinto_led.ino`)
